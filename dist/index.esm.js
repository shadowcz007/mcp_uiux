...
var InputSchemaForm = function (_a) {
    ...
    if (!survey)
        return null;
    return React__default.createElement(Survey, { model: survey, rootNodeClassName: "mcp-uiux-input-schema-form" });
};
...
var SciFiMCPStatus = function (_a) {
    ...
    return (React__default.createElement("div", { className: "sci-fi-container" },
        React__default.createElement("div", { className: "hologram-title" },
            ...
            React__default.createElement("div", { className: "status-indicator" }, loading ? (React__default.createElement("span", { className: "pulse loading" }, "\u7CFB\u7EDF\u626B\u63CF\u4E2D...")) : error ? (React__default.createElement("span", { className: "pulse error" }, "\u8B66\u544A\uFF1A\u7CFB\u7EDF\u5F02\u5E38")) : (React__default.createElement("span", { className: "pulse active" },
                "\u7CFB\u7EDF\u5728\u7EBF ",
        ...
        Object.keys(notifications).map(function (key, index) { return (React__default.createElement("div", { key: index },
            key,
            ": ",
            notifications[key])); }),
        !loading && !error && (React__default.createElement("div", { style: { display: 'flex' } },
            React__default.createElement("div", { className: "data-grid" },
                tools.length > 0 && React__default.createElement("div", { className: "module" },
                    ...
                    React__default.createElement("div", { className: "scrollable-content" }, tools.map(function (tool, index) { return (React__default.createElement("div", { key: index, className: "item", onClick: function () { return handleItemSelect(tool); } },
                        React__default.createElement("span", { className: "item-indicator" }),
                        tool.name)); }))),
                resources.length > 0 && React__default.createElement("div", { className: "module" },
                    React__default.createElement("div", { className: "module-header" },
                        React__default.createElement("span", { className: "module-icon" }, "\uD83D\uDCE6"),
                ...
                prompts.length > 0 && React__default.createElement("div", { className: "module" },
                    React__default.createElement("div", { className: "module-header" },
                        React__default.createElement("span", { className: "module-icon" }, "\uD83D\uDCA1"),
                    ...
                    React__default.createElement("div", { className: "scrollable-content" }, prompts.map(function (prompt, index) { return (React__default.createElement("div", { key: index, className: "item" },
                        React__default.createElement("span", { className: "item-indicator" }),
                        prompt.name)); })))),
            selectedItem && React__default.createElement(InputSchemaForm, { tool: selectedItem, onComplete: handleFormComplete }),
            formData && React__default.createElement("div", null,
                React__default.createElement("h4", null, "\u6570\u636E"),
                React__default.createElement("pre", null, JSON.stringify(formData, null, 2)))))));
};
...
var MCPStatus = function (_a) {
    ...
    return (React__default.createElement("div", { className: className, style: style },
        React__default.createElement(SciFiMCPStatus, { serverInfo: serverInfo, loading: loading, error: error, tools: tools, resources: resources, resourceTemplates: resourceTemplates, prompts: prompts, notifications: notifications })));
};
