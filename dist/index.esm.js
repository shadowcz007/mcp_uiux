...
import React__default, { useRef, useEffect, useCallback, useState, useContext } from 'react';
...
var useMCP$1 = function (_a) {
    ...
    return {
        executeTool: useCallback(function (toolName, args) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
        ...
        reconnect: useCallback(function () {
            var _a;
            (_a = mcpClientRef.current) === null || _a === void 0 ? void 0 : _a.reconnect();
        }, []),
        getResources: useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                return [2 /*return*/, (_a = mcpClientRef.current) === null || _a === void 0 ? void 0 : _a.getResources()];
            });
        }); }, []),
        readResource: useCallback(function (uri) { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                return [2 /*return*/, (_a = mcpClientRef.current) === null || _a === void 0 ? void 0 : _a.readResource(uri)];
            });
        }); }, []),
        getToolsList: useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                return [2 /*return*/, (_a = mcpClientRef.current) === null || _a === void 0 ? void 0 : _a.getToolsList()];
            });
        }); }, []),
        getPromptsList: useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                return [2 /*return*/, (_a = mcpClientRef.current) === null || _a === void 0 ? void 0 : _a.getPromptsList()];
            });
        }); }, []),
        getPrompt: useCallback(function (name, args) {
            if (args === void 0) { args = {}; }
        ...
        getResourceTemplates: useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                return [2 /*return*/, (_a = mcpClientRef.current) === null || _a === void 0 ? void 0 : _a.getResourceTemplates()];
            });
        }); }, []),
        expandUriByVariables: useCallback(function (template, variables) {
            var _a;
            return (_a = mcpClientRef.current) === null || _a === void 0 ? void 0 : _a.expandUriByVariables(template, variables);
        }, []),
        getTemplateVariables: useCallback(function (template) {
            var _a;
...
export { MCPProvider, MCPStatus, useMCP$1 as useMCP };
