...
var useMCP = function (_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.url, url = _c === void 0 ? 'http://localhost:8000' : _c, onToolsReady = _b.onToolsReady, onToolResult = _b.onToolResult, onError = _b.onError, onReady = _b.onReady;
    var mcpClientRef = (0, react_1.useRef)(null);
    var _d = (0, react_1.useState)(false), loading = _d[0], setLoading = _d[1];
    var _e = (0, react_1.useState)(null), error = _e[0], setError = _e[1];
    var _f = (0, react_1.useState)([]), tools = _f[0], setTools = _f[1];
    var _g = (0, react_1.useState)([]), resources = _g[0], setResources = _g[1];
    var _h = (0, react_1.useState)([]), resourceTemplates = _h[0], setResourceTemplates = _h[1];
    var _j = (0, react_1.useState)([]), prompts = _j[0], setPrompts = _j[1];
    ...
    return { mcpClient: mcpClientRef.current, loading: loading, error: error, tools: tools, resources: resources, resourceTemplates: resourceTemplates, prompts: prompts, connect: (0, react_1.useCallback)(function (sseUrl, resourceFilter) { return __awaiter(void 0, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mcpClientRef.current = new MCPClient({
                            url: sseUrl,
                            onToolsReady: function (newTools) {
                                setTools(newTools);
                                onToolsReady === null || onToolsReady === void 0 ? void 0 : onToolsReady(newTools);
                            },
                            onToolResult: onToolResult,
                            ...
                            onResourcesReady: function (newResources) {
                                setResources(newResources);
                            },
                            onResourceTemplatesReady: function (newTemplates) {
                                setResourceTemplates(newTemplates);
                            },
                            onPromptsReady: function (newPrompts) {
                                setPrompts(newPrompts);
                            },
                            onReady: onReady
                        });
                        // 连接到服务器
                        return [4 /*yield*/, mcpClientRef.current.connect()];
                    case 1:
                        // 连接到服务器
                        _a.sent();
                        setLoading(false);
                    ...
                    case 2:
                        err_1 = _a.sent();
                        setError(err_1 instanceof Error ? err_1.message : '连接失败');
                        setLoading(false);
                        throw err_1;
                    case 3: return [2 /*return*/];
                }
